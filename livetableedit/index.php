...
<head>
    ...
    <link href="/var/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css">
...
while($row = $result->fetch_array()){
		...
		<script src="/var/bootstrap/bootstrap3-editable-1.5.1/bootstrap3-editable/js/bootstrap.min.js"></script>
